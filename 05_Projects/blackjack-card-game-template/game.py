...
class Game:
    ...
    def get_player_hit_or_stay(self):
        ...
        print("Your are dealt:", self.player.get_str_hand())
    ...
    def confirm_start(self):
        answer = input(f"You starting with ${self.player.balance}, would you like to play? ").lower()
    ...
    def start_game(self):
        while self.player.balance > 0:
            ...
            print("You've ran out of money. Please restart this program to try play again.")